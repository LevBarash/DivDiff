...
double *z, *z2; ExExFloat *h, *ddd, *divdiff; 
int CurrentLength; int s; double mu; ExExFloat expmu;
...
void AllocateMem(){
	...
	divdiff = new ExExFloat[maxlen+extralen+1]; ddd = new ExExFloat[maxlen*smax];
	CurrentLength = 0; s = 1;
}
